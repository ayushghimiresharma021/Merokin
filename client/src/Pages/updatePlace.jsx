...
function UpdatePlace() {
    ...
    useEffect(() => {
            ...
            axios.get(`/place/${id}`).then(response => {
                ...
                setExtraDescription(data.extraDescription)
    ...
    const saveDetails = async (e) => {
        e.preventDefault()
            ...
            console.log('wring place')
            await axios.patch('/place/changesPlace', {
                id, title, address, photo, description, perks, checkIn, checkOut, extraDescription, maxGuests,price
            }).then((response) => {
                const { data } = response
                setTitle(data.title)
                setAddress(data.address)
